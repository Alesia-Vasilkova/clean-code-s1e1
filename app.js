...
const editTask = function () {
  ...
  const editBtn = listItem.querySelector(".edit-save");
  ...
  editInput.classList.toggle("hiden");
  label.classList.toggle("hiden");
};
...
const taskCompleted = function () {
  ...
  label.classList.add("complete-task-label");
...
const taskIncomplete = function () {
  ...
  const listItem = this.parentNode;
  const label = listItem.querySelector(".task-label");
  label.classList.remove("complete-task-label");
  incompleteTaskHolder.appendChild(listItem);
  bindTaskEvents(listItem, taskCompleted);
};
...
const bindTaskEvents = function (taskListItem, checkBoxEventHandler) {
  ...
  const editButton = taskListItem.querySelector(".edit-save");
